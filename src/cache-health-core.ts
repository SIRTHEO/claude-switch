// src/cache-health-core.ts
// JSONL parsing + cache-health summarisation — the read+compute core.
//
 ...
 */
export function extractAssistantEntry(v: unknown): AssistantEntryNormalised | null {
...
export function extractTokenCount(v: unknown): number {
